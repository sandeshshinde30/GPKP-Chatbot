	...
	<div class="container">
		<div class="chat">
			<div class="chat-header">
				<div class="profile">
					<div class="left">
						<img src="GPKP.jpg" alt="GPKP Logo" height = 50px id="GPKP">
						<h2>GPKP Chatbot</h2>
					</div>
			...
			<div class="chat-footer">
	            ...
	            <button type="submit" id="send_btn"><img src="send.png" alt="" height="55px" id="send"></button>
				<img src="happy.png" alt="Happy" id="happy" height=30px>
				<label for="">CREATED BY <b>AMEY & SANDESH</b></label>
			</div>
