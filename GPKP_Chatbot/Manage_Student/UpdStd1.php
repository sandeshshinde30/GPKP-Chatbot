...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <link rel="stylesheet" href="UpdStd1.css">
      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form action = "UpdStd1.php" method = "post">
              ...
              <div class="row">
                ...
                <div class="form-outline">
                    <input type="text" name="rollno" class="form-control form-control-lg" value = "" disabled = "disabled" />
              ...
              <div class="mt-4 pt-2">
                ...
                <a href="UpdStd.php"> <input class="btn btn-primary btn-lg" type="button" value="Back"/> </a>
              </div>
...
if(!$conn)
  ...
  { 
    ...
    if(empty($_POST['firstName']) && empty($_POST['lastName']) && empty($_POST['gender']) && empty($_POST['emailAddress'])
    ...
    {
      $sql = "UPDATE stud_tbl SET FName = '$fname' , LName = '$lname',  Gender = '$gender' , EMail = '$email' , 
      DOB = '$dob' , Password = '$password' , CPassword = '$cpassword' , Branch = '$branch' WHERE Roll_No = '$roll'";
