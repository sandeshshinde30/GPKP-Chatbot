      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form action = "stud_update1.php" method = "post">
              ...
              <div class="row">
                ...
                <div class="form-outline">
                    <input type="text" name="rollno" class="form-control form-control-lg" value = ""  />
...
if(!$conn)
  ...
  { 
    ...
    {
      $sql = "UPDATE stud_tbl SET FName = '$fname' , LName = '$lname' , Roll_No = '$rollno' ,  Gender = '$gender' , EMail = '$email' , 
